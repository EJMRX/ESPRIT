...
export default function CatalogSearch() {
  ...
  const [searchResults, setSearchResults] = useState(sampleProducts.slice(0, 1))
  ...
  return (
    <div className="p-6 bg-gradient-to-b from-blue-100 to-blue-200 min-h-screen">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-white mb-4">Recherche d'un article</h1>
      </div>
